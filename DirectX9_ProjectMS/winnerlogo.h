...
#define TEXTURE_WINNERLOGO_SIZE000_X				(TEXTURE_WINNERLOGO_SIZE000_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_WINNERLOGO_PIXEL000_X/2*SCREEN_SCALE)						// サイズ
#define TEXTURE_WINNERLOGO_SIZE000_Y				(TEXTURE_WINNERLOGO_SIZE000_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_WINNERLOGO_PIXEL000_Y/2*SCREEN_SCALE)						// サイズ
#define TEXTURE_WINNERLOGO_SIZE001_X				(TEXTURE_WINNERLOGO_SIZE001_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_WINNERLOGO_PIXEL001_X/2*SCREEN_SCALE)					// サイズ
#define TEXTURE_WINNERLOGO_SIZE001_Y				(TEXTURE_WINNERLOGO_SIZE001_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_WINNERLOGO_PIXEL001_Y/2*SCREEN_SCALE)						// サイズ
