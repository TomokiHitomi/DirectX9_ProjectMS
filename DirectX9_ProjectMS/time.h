...
//
//=============================================================================
#define TEXTURE_TIME_000					"data/TEXTURE/time.png"											// gage hp
...
#define TEXTURE_TIME_SIZE000_X				(TEXTURE_TIME_SIZE000_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_TIME_PIXEL000_X*1.75)						// サイズ
#define TEXTURE_TIME_SIZE000_Y				(TEXTURE_TIME_SIZE000_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_TIME_PIXEL000_Y*1.75)						// サイズ
