...
#define TEXTURE_RIGHTLEFT_POSITION000_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION000_Y+SCREEN_HEIGHT/4-TEXTURE_RIGHTLEFT_SIZE000_Y)	// ポジション
...
#define TEXTURE_RIGHTLEFT_POSITION001_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION001_Y+SCREEN_HEIGHT/4-TEXTURE_RIGHTLEFT_SIZE000_Y)	// ポジション
...
#define TEXTURE_RIGHTLEFT_POSITION002_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION002_Y+SCREEN_HEIGHT/4-TEXTURE_RIGHTLEFT_SIZE000_Y)										// ポジション
...
#define TEXTURE_RIGHTLEFT_POSITION003_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION003_Y+SCREEN_HEIGHT/4-TEXTURE_RIGHTLEFT_SIZE000_Y)										// ポジション
