...
//
//=============================================================================
#define TEXTURE_RIGHTLEFT_000					"data/TEXTURE/left310.png"												// gage hp
#define TEXTURE_RIGHTLEFT_001					"data/TEXTURE/right310.png"										// gage hp
...
#define TEXTURE_RIGHTLEFT_SIZE000_X				(TEXTURE_RIGHTLEFT_SIZE000_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL000_X)						// サイズ
#define TEXTURE_RIGHTLEFT_SIZE000_Y				(TEXTURE_RIGHTLEFT_SIZE000_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL000_Y)						// サイズ
#define TEXTURE_RIGHTLEFT_SIZE001_X				(TEXTURE_RIGHTLEFT_SIZE001_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL001_X)					// サイズ
#define TEXTURE_RIGHTLEFT_SIZE001_Y				(TEXTURE_RIGHTLEFT_SIZE001_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL001_Y)						// サイズ
#define TEXTURE_RIGHTLEFT_SIZE002_X				(TEXTURE_RIGHTLEFT_SIZE002_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL002_X)					// サイズ
#define TEXTURE_RIGHTLEFT_SIZE002_Y				(TEXTURE_RIGHTLEFT_SIZE002_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL002_Y)						// サイズ
#define TEXTURE_RIGHTLEFT_SIZE003_X				(TEXTURE_RIGHTLEFT_SIZE002_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL003_X)					// サイズ
#define TEXTURE_RIGHTLEFT_SIZE003_Y				(TEXTURE_RIGHTLEFT_SIZE002_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_RIGHTLEFT_PIXEL003_Y)						// サイズ
...
#define TEXTURE_RIGHTLEFT_POSITION000_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION000_Y+SCREEN_HEIGHT-TEXTURE_RIGHTLEFT_SIZE000_Y)	// ポジション
...
#define TEXTURE_RIGHTLEFT_POSITION001_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION001_Y+SCREEN_HEIGHT-TEXTURE_RIGHTLEFT_SIZE000_Y)	// ポジション
...
#define TEXTURE_RIGHTLEFT_POSITION002_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION002_Y+SCREEN_HEIGHT-TEXTURE_RIGHTLEFT_SIZE000_Y)										// ポジション
...
#define TEXTURE_RIGHTLEFT_POSITION003_Y			(TEXTURE_RIGHTLEFT_OFFSET_POSITION003_Y+SCREEN_HEIGHT-TEXTURE_RIGHTLEFT_SIZE000_Y)										// ポジション
