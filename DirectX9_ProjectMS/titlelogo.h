...
#define TEXTURE_TITLELOGO_001					"data/TEXTURE/start000.png"											// ロゴ
...
#define TEXTURE_TITLELOGO_POSITION000_Y			(SCREEN_HEIGHT/3.25)												// ポジション
#define TEXTURE_TITLELOGO_POSITION001_X			(SCREEN_WIDTH/2)													// ポジション
#define TEXTURE_TITLELOGO_POSITION001_Y			(SCREEN_HEIGHT/1.25)												// ポジション
