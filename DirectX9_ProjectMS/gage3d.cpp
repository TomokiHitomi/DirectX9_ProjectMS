...
HRESULT Gage3d::Init()
{
	...
	for (int i = 0; i < NUM_GAGE3D; i++)
	{
		...
		if (i == 1)
		{
			...
			Gage3dObj[i].Texture = Gage3dObj[0].pD3DTexture;
		}
		if (i == 2)
		{
		...
		if (i == 14)
		{
			...
			Gage3dObj[i].Use = false;
			Gage3dObj[i].Damege = true;
			Gage3dObj[i].Texture = Gage3dObj[10].pD3DTexture;
		}
		if (i == 15)
		{
			...
			Gage3dObj[i].Use = false;
			Gage3dObj[i].Damege = true;
			Gage3dObj[i].Texture = Gage3dObj[11].pD3DTexture;
		}
		if (i == 16)
		{
			...
			Gage3dObj[i].Use = false;
			Gage3dObj[i].Damege = true;
			Gage3dObj[i].Texture = Gage3dObj[12].pD3DTexture;
		}
		if (i == 17)
		{
			//if (type == 0)
			...
			Gage3dObj[i].Use = false;
			Gage3dObj[i].Damege = true;
			Gage3dObj[i].Texture = Gage3dObj[13].pD3DTexture;
		}
	...
	Gage3dObj[10 + nTemp].Use = true;
	nTemp = SceneManager::GetSelectChar(1);
	Gage3dObj[14 + nTemp].Use = true;
	return S_OK;
}
...
// HP・SPの初期化
//=============================================================================
void Gage3d::InitStatus(void)
{
	for (unsigned int i = 0; i < NUM_GAGE3D; i++)
	{
		if (i == 0)
		{
			Gage3dObj[i].Pos = D3DXVECTOR3(TEXTURE_GAGE3D_POSITION000_X, TEXTURE_GAGE3D_POSITION000_Y, 0.0f);
...
void Gage3d::Uninit(void)
{
	for (int i = 0; i < NUM_GAGE3D; i++)
	{
		...
		{
			if (Gage3dObj[0].pD3DTexture != NULL)	// (*31)
			{	// テクスチャの開放
				Gage3dObj[0].pD3DTexture->Release();
				Gage3dObj[0].pD3DTexture = NULL;
			}
		}
		if (i == 10 || i == 14)
		{
			if (Gage3dObj[10].pD3DTexture != NULL)	// (*31)
			{	// テクスチャの開放
				Gage3dObj[10].pD3DTexture->Release();
				Gage3dObj[10].pD3DTexture = NULL;
			}
		}
		if (i == 11 || i == 15)
		{
			if (Gage3dObj[11].pD3DTexture != NULL)	// (*31)
			{	// テクスチャの開放
				Gage3dObj[11].pD3DTexture->Release();
				Gage3dObj[11].pD3DTexture = NULL;
			}
		}
		if (i == 12 || i == 16)
		{
			if (Gage3dObj[12].pD3DTexture != NULL)	// (*31)
			{	// テクスチャの開放
				Gage3dObj[12].pD3DTexture->Release();
				Gage3dObj[12].pD3DTexture = NULL;
			}
		}
		if (i == 13 || i == 17)
		{
			if (Gage3dObj[13].pD3DTexture != NULL)	// (*31)
			{	// テクスチャの開放
				Gage3dObj[13].pD3DTexture->Release();
				Gage3dObj[13].pD3DTexture = NULL;
			}
		}
	}
		...
		if (CameraManager::GetType() == CameraManager::MULTI1)
		{
			...
			if (i == 1 || i == 3 || i == 5 || i == 7 || i == 9 || i == 14 || i == 15 || i == 16 || i == 17)
			{
				...
				if (Gage3dObj[i].Use == true)
				{
					...
					if (i == 0 || i == 1 || i == 2 || i == 3 || i == 4 || i == 5 || i == 6 || i == 7 || i == 8 || i == 9)
					{
						pDevice->SetTexture(0, Gage3dObj[0].pD3DTexture);
					}
					if (i == 10 || i == 14)
					{
						pDevice->SetTexture(0, Gage3dObj[10].pD3DTexture);
					}
					if (i == 11 || i == 15)
					{
						pDevice->SetTexture(0, Gage3dObj[11].pD3DTexture);
					}
					if (i == 12 || i == 16)
					{
						pDevice->SetTexture(0, Gage3dObj[12].pD3DTexture);
					}
					if (i == 13 || i == 17)
					{
						pDevice->SetTexture(0, Gage3dObj[13].pD3DTexture);
					}
...
void Gage3d::DamegeReduce(float Damege, int player)
{
	if (player == 0)
	{
		...
		if (Gage3dObj[4].NowHp < 0.0f) Gage3dObj[4].NowHp = 0.0f;
	...
	if (player == 1)
	{
		...
		if (Gage3dObj[5].NowHp < 0.0f) Gage3dObj[5].NowHp = 0.0f;
...
void Gage3d::DamegeAdd(float Damege, int player)
{
	...
	{
		Gage3dObj[4].NowHp += Damege;
		if (Gage3dObj[4].NowHp > TEXTURE_GAGE3D_MAX_HP) Gage3dObj[4].NowHp = TEXTURE_GAGE3D_MAX_HP;
	...
	{
		Gage3dObj[5].NowHp += Damege;
		if (Gage3dObj[5].NowHp > TEXTURE_GAGE3D_MAX_HP) Gage3dObj[5].NowHp = TEXTURE_GAGE3D_MAX_HP;
		Gage3dObj[5].TextureSize.x = TEXTURE_GAGE3D_SIZE005_X / TEXTURE_GAGE3D_MAX_HP / Gage3dObj[5].NowHp;
...
void Gage3d::SkillReduce(float Damege, int player)
{
	if (player == 0)
	{
		...
		if (Gage3dObj[8].NowSkill < 0.0f) Gage3dObj[8].NowSkill = 0.0f;
	...
	if (player == 1)
	{
		...
		if (Gage3dObj[9].NowSkill < 0.0f) Gage3dObj[9].NowSkill = 0.0f;
...
void Gage3d::SkillAdd(float Damege, int player)
{
	...
	{
		Gage3dObj[8].NowSkill += Damege;
		if (Gage3dObj[8].NowSkill > TEXTURE_GAGE3D_MAX_HP) Gage3dObj[8].NowSkill = TEXTURE_GAGE3D_MAX_HP;
	...
	{
		Gage3dObj[9].NowSkill += Damege;
		if (Gage3dObj[9].NowSkill > TEXTURE_GAGE3D_MAX_HP) Gage3dObj[9].NowSkill = TEXTURE_GAGE3D_MAX_HP;
