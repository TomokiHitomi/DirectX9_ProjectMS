...
#define TEXTURE_ROUNDLOGO_SIZE000_X				(TEXTURE_ROUNDLOGO_SIZE000_LATE_X*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_ROUNDLOGO_PIXEL000_X*1.5/2*SCREEN_SCALE)						// サイズ
#define TEXTURE_ROUNDLOGO_SIZE000_Y				(TEXTURE_ROUNDLOGO_SIZE000_LATE_Y*SCREEN_WIDTH/SCREEN_HEIGHT*TEXTURE_ROUNDLOGO_PIXEL000_Y*1.5/2*SCREEN_SCALE)						// サイズ
