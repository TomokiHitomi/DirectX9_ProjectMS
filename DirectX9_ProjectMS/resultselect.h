...
#define TEXTURE_RESULTSELECT_OFFSET_POSITION000_Y	(-TEXTURE_RESULTSELECT_SIZE000_Y)																// オフセットポジション
#define TEXTURE_RESULTSELECT_OFFSET_POSITION001_X	(0.0f)																// オフセットポジション
#define TEXTURE_RESULTSELECT_OFFSET_POSITION001_Y	(0.0f)											// オフセットポジション
#define TEXTURE_RESULTSELECT_OFFSET_POSITION002_X	(0.0f)																// オフセットポジション
#define TEXTURE_RESULTSELECT_OFFSET_POSITION002_Y	(TEXTURE_RESULTSELECT_SIZE000_Y)											// オフセットポジション
...
#define TEXTURE_RESULTSELECT_POSITION001_Y			(TEXTURE_RESULTSELECT_OFFSET_POSITION001_Y+SCREEN_HEIGHT/2-TEXTURE_RESULTSELECT_SIZE000_Y+TEXTURE_RESULTSELECT_SIZE000_Y*2)	// ポジション
#define TEXTURE_RESULTSELECT_POSITION002_X			(TEXTURE_RESULTSELECT_POSITION000_X)										// ポジション
#define TEXTURE_RESULTSELECT_POSITION002_Y			(TEXTURE_RESULTSELECT_OFFSET_POSITION002_Y+SCREEN_HEIGHT/2-TEXTURE_RESULTSELECT_SIZE000_Y+TEXTURE_RESULTSELECT_SIZE000_Y*4)										// ポジション
