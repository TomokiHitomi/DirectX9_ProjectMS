...
#define TEXTURE_SELECT_MOVE_OFFSET_X		(TEXTURE_SELECT00_POSITION_OFFSET-(SCREEN_WIDTH/SCREEN_WIDTH)*65/2*SCREEN_SCALE)					// 同上 (*33)
#define TEXTURE_SELECT_MOVE_OFFSET_Y		(SCREEN_HEIGHT/(SCREEN_HEIGHT/100)*10/2*SCREEN_SCALE)												// 同上 (*33)

#define TEXTURE_SELECT_MOVE_DISTANCE_X		(SCREEN_HEIGHT/SCREEN_HEIGHT*150/2*SCREEN_SCALE)
