...
#define TEXTURE_GAGE_SIZE006_X				(TEXTURE_GAGE_SIZE006_LATE_X*SCREEN_WIDTH/4)						// サイズ
...
#define TEXTURE_GAGE_SIZE011_X				(TEXTURE_GAGE_SIZE001_LATE_X*SCREEN_WIDTH/4)						// サイズ
#define TEXTURE_GAGE_SIZE011_Y				(TEXTURE_GAGE_SIZE001_LATE_Y*SCREEN_HEIGHT/16)						// サイズ
#define TEXTURE_GAGE_SIZE012_X				(TEXTURE_GAGE_SIZE002_LATE_X*SCREEN_WIDTH/4)						// サイズ
#define TEXTURE_GAGE_SIZE012_Y				(TEXTURE_GAGE_SIZE002_LATE_Y*SCREEN_HEIGHT/16)						// サイズ
#define TEXTURE_GAGE_SIZE013_X				(TEXTURE_GAGE_SIZE003_LATE_X*SCREEN_WIDTH/4)						// サイズ
#define TEXTURE_GAGE_SIZE013_Y				(TEXTURE_GAGE_SIZE003_LATE_Y*SCREEN_HEIGHT/16)						// サイズ
#define TEXTURE_GAGE_SIZE014_X				(TEXTURE_GAGE_SIZE000_LATE_X*SCREEN_WIDTH/4)						// サイズ
#define TEXTURE_GAGE_SIZE014_Y				(TEXTURE_GAGE_SIZE000_LATE_Y*SCREEN_HEIGHT/16)						// サイズ
#define TEXTURE_GAGE_SIZE015_X				(TEXTURE_GAGE_SIZE001_LATE_X*SCREEN_WIDTH/4)						// サイズ
#define TEXTURE_GAGE_SIZE015_Y				(TEXTURE_GAGE_SIZE001_LATE_Y*SCREEN_HEIGHT/16)						// サイズ
#define TEXTURE_GAGE_SIZE016_X				(TEXTURE_GAGE_SIZE002_LATE_X*SCREEN_WIDTH/4)						// サイズ
#define TEXTURE_GAGE_SIZE016_Y				(TEXTURE_GAGE_SIZE002_LATE_Y*SCREEN_HEIGHT/16)						// サイズ
#define TEXTURE_GAGE_SIZE017_X				(TEXTURE_GAGE_SIZE003_LATE_X*SCREEN_WIDTH/4)						// サイズ
...
#define TEXTURE_GAGE_POSITION001_X			(TEXTURE_GAGE_OFFSET_POSITION000_X+SCREEN_WIDTH/2+SCREEN_WIDTH/4)	// ポジション
...
#define TEXTURE_GAGE_ANGLE_X				(-0.25)																// ポジション
