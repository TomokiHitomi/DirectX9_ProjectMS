...
#define TEXTURE_GAGE_013					"data/NAME/ドクター000.png"											// name
#define TEXTURE_GAGE_011					"data/NAME/パティシエ000.png"											// name
#define TEXTURE_GAGE_012					"data/NAME/アイドル000.png"											// name
...
#define TEXTURE_GAGE_SIZE010_Y				(TEXTURE_GAGE_SIZE000_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
#define TEXTURE_GAGE_SIZE011_X				(TEXTURE_GAGE_SIZE001_LATE_X*SCREEN_WIDTH/6)						// サイズ
#define TEXTURE_GAGE_SIZE011_Y				(TEXTURE_GAGE_SIZE001_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
#define TEXTURE_GAGE_SIZE012_X				(TEXTURE_GAGE_SIZE002_LATE_X*SCREEN_WIDTH/6)						// サイズ
#define TEXTURE_GAGE_SIZE012_Y				(TEXTURE_GAGE_SIZE002_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
#define TEXTURE_GAGE_SIZE013_X				(TEXTURE_GAGE_SIZE003_LATE_X*SCREEN_WIDTH/6)						// サイズ
#define TEXTURE_GAGE_SIZE013_Y				(TEXTURE_GAGE_SIZE003_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
#define TEXTURE_GAGE_SIZE014_X				(TEXTURE_GAGE_SIZE000_LATE_X*SCREEN_WIDTH/6)						// サイズ
#define TEXTURE_GAGE_SIZE014_Y				(TEXTURE_GAGE_SIZE000_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
#define TEXTURE_GAGE_SIZE015_X				(TEXTURE_GAGE_SIZE001_LATE_X*SCREEN_WIDTH/6)						// サイズ
#define TEXTURE_GAGE_SIZE015_Y				(TEXTURE_GAGE_SIZE001_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
#define TEXTURE_GAGE_SIZE016_X				(TEXTURE_GAGE_SIZE002_LATE_X*SCREEN_WIDTH/6)						// サイズ
#define TEXTURE_GAGE_SIZE016_Y				(TEXTURE_GAGE_SIZE002_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
#define TEXTURE_GAGE_SIZE017_X				(TEXTURE_GAGE_SIZE003_LATE_X*SCREEN_WIDTH/6)						// サイズ
#define TEXTURE_GAGE_SIZE017_Y				(TEXTURE_GAGE_SIZE003_LATE_Y*SCREEN_HEIGHT/18)						// サイズ
